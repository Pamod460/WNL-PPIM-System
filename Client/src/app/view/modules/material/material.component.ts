...
// @ts-ignore
    this.material.unittype = this.unitTypes.find(g => g.id === this.material.unittype.id);
    // @ts-ignore
    this.material.materialstatus = this.materialStatuses.find(g => g.id === this.material.materialstatus.id);
    // @ts-ignore
    this.material.materialsubcategory = this.materialSubcategories.find(g => g.id === this.material.materialsubcategory.id);
    this.material.photo = "";
